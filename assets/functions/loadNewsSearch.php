...
<div  id="listOfNews" class="listOfNews">
	...
	for ($i=0; isset($resultSearch[$i]['id_news']) ; $i++) { 
...
<?php
	...
	?>
		<button id="newsSearchButton" class="buttonLargeBl" value="<?php echo $_POST["version"];?>" onclick="showMoreNewsSearch()">MORE NEWS</button>
	<?php
	}
?>