...
<?php
	for ($i=0; isset($searchNews[$i]['id_news']) && $_POST["version"] >= $i ; $i++) { 
...
?>
	...
	?>	
		<button id="newsBehindButton" class="buttonLargeBl1" value="<?php echo $_POST["version"];?>" onclick="showMoreNews()">MORE NEWS</button>
	<?php
	}
?>
